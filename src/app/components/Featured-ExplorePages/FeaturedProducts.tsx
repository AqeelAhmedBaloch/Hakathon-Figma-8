...
<div className="flex justify-between">
  ...
  <div className="relative w-[240px]">
    ...
    <Image src={Images.image1} alt="Image1" width={300} height={300} />
  ...
  <div className="relative w-[240px]">
    ...
    <Image src={Images.image2} alt="Image2" width={300} height={300} />
  ...
  {/* Product 3 */}
  <div className="relative w-[240px]">
    <Image src={Images.image3} alt="Image3" width={300} height={300} />
    <p className="text-[10px] text-[#007580] mt-2">Library Stool Chair</p>
    <p className="text-[14px] flex items-center mt-1">
      $20
      <IoCartOutline className="text-[30px] rounded-md bg-slate-300 ml-[60%] p-1" />
  ...
  {/* Product 4 */}
  <div className="relative w-[240px]">
    <Image src={Images.image4} alt="Image4" width={300} height={300} />
    <p className="text-[10px] text-[#007580] mt-2">Library Stool Chair</p>
    <p className="text-[14px] flex items-center mt-1">
      $20
      <IoCartOutline className="text-[30px] rounded-md bg-slate-300 ml-[60%] p-1" />
