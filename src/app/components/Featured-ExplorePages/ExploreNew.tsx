...
return (
  <div className="relative items-center justify-center w-[1300px] h-[470px] mt-40">
      ...
      <div className="grid grid-cols-2 gap-4 ml-[250px]">
        <Image src={Images.image2} alt="Card1" width={250} height={250} />
        <Image src={Images.image3} alt="Card2" width={250} height={250} />
        <Image src={Images.image4} alt="Card4" width={250} height={250} />
        <Image src={Images.image3} alt="Card2" width={250} height={250} />
      </div>
    </div>
  </div>
